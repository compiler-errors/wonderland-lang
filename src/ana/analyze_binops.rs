...
impl AnalyzeBinops {
    fn get_call(
        ...
        let (trt_name, fn_name) = match kind {
            ...
            BinOpKind::Greater => ("Greater", "grt"),
            BinOpKind::Less => ("Less", "less"),
            BinOpKind::GreaterEqual => ("GreaterEqual", "ge"),
            BinOpKind::LessEqual => ("LessEqual", "le"),
            BinOpKind::EqualsEquals => ("EqualsEquals", "eq"),
            BinOpKind::NotEqual => ("NotEqual", "ne"),
